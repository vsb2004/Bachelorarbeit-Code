...
dicom_files = reader.GetGDCMSeriesFileNames("/data/pt_gr_weiskopf_7t-mri-imagedata/Phantom/Phantom_kroner/260428_135051/S6_noT1_petra_tra_FA1_deg")
...
# # .nrrd einlesen
# mrt = sitk.ReadImage("/data/u_benndorf_thesis/BA/petra_paper_crop.nrrd")
...
sitk.WriteImage(mrt_corrected_2, "/data/u_benndorf_thesis/BA/petra_paper_n4_corrected.nrrd")
print("Fertig")
